...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd)
{
	...
	m_vertexShader = ArtemisEngine::ShaderLoader::GetVertexShader("Color").Get();
	m_pixelShader = ArtemisEngine::ShaderLoader::GetPixelShader("Color").Get();
	...
	ComPtr<ID3DBlob> vertexShaderBlob = ArtemisEngine::ShaderLoader::GetVertexShaderBLOB("Color").Get();
